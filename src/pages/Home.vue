        ...
        <header class="bg-teal-700 text-white sticky top-0 z-10">
            <section class="max-w-4xl mx-auto p-4 flex justify-between items-center">
                ...
                <div>
                    ...
                    <nav class="hidden md:block space-x-8 text-xl" aria-label="main">
                        <a href="#rockets" class="hover:opacity-90 cursor-pointer">Our {{ firstSmallTitle }}</a>
            ...
            <section id="mobile-menu" :class="[
                ...
                <nav class="flex flex-col min-h-screen items-center py-8" aria-label="mobile">
                    ...
                    <a href="#rockets" class="w-full text-center py-6 hover:opacity-90">{{
                        firstSmallTitle
                    }}</a>
                    <a href="#testimonials" class="w-full text-center py-6 hover:opacity-90">{{ secondSmallTitle }}</a>
                    <a href="#contact" class="w-full text-center py-6 hover:opacity-90">{{
                        thirdSmallTitle
                    }}</a>
                    <a href="#foot" class="w-full text-center py-6 hover:opacity-90">Legal</a>
                    <a href="#" class="w-full text-center py-6 hover:opacity-90" @click.stop="LoginOut">Login Out</a>
                </nav>
            </section>
        </header>
        <main class="max-w-4xl mx-auto">
            <section id="hero"
                class="flex flex-col-reverse justify-cneter sm:flex-row p-6 items-center gap-8 mb-12 scroll-mt-40 widescreen:section-min-height tailscreen:section-min-height">
                <aritcle class="sm:w-1/2">
                    <h2
                        class="max-w-md text-4xl font-bold text-center sm:text-5xl sm:text-left text-slate-900 dark:text-white">
                        We Boldy Go
                        <span class="text-indigo-700 dark:text-indigo-300">Where No Rockets</span>
                        Has Gone Before...
                    </h2>

                    <p class="max-w-md text-2xl mt-4 text-center sm:text-left text-slate-700 dark:text-slate-400">
                        We're buiding rockets for the next century today. From the moon to
                ...
                <img class="w-1/2" src="../../public/rocketdab.png" alt="Rocket Dab" />
            </section>
            <hr class="mx-auto bg-black dark:bg-white w-1/2" />
            <section id="rockets" class="p-6 my-12 scroll-m-20 widescreen:section-min-height tailscreen:section-min-height">
                ...
                <ul class="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8">
                    <li
                        class="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white py-6 px-2 rounded-3xl shadow-xl dark:bg-black hover:-translate-y-3 hover:shadow-2xl duration-500 cursor-pointer">
                        <img class="w-1/2 mb-6" src="./../../public/rocketman.png" alt="Explorer" />
                    ...
                    <li
                        class="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white py-6 px-2 rounded-3xl shadow-xl dark:bg-black hover:-translate-y-3 hover:shadow-2xl duration-500 cursor-pointer">
                        <img class="w-1/2 mb-6" src="./../../public/rocketride.png" alt="Adventurer" />
                        <h3 class="text-3xl text-center text-slate-900 dark:text-white">
                            Adventurer
                        </h3>
                        <p class="hidden sm:block text-3xl text-center mt-2 text-slate-500 dark:text-slate-400">
                    ...
                    <li
                        class="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white py-6 px-2 rounded-3xl shadow-xl dark:bg-black hover:-translate-y-3 hover:shadow-2xl duration-500 cursor-pointer">
                        <img class="w-1/2 mb-6" src="./../../public/rocketlaunch.png" alt="Infinity" />
                        <h3 class="text-3xl text-center text-slate-900 dark:text-white">
                            Infinity
                        </h3>
                        <p class="hidden sm:block text-3xl text-center mt-2 text-slate-500 dark:text-slate-400">
            ...
            <section id="testimonials"
                class="p-6 my-12 scroll-mt-20 widescreen:section-min-height tailscreen:section-min-height">
                <h2 class="text-4xl font-bold text-center sm:text-5xl mb-6 text-slate-900 dark:text-white">
                    Our {{ secondSmallTitle }}
                </h2>
                <figure class="my-12">
                    <blockquote class="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
                        <p
                            class="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-white before:opacity-25 before:tansform before:translate-x-2 before:-translate-y-2 after:content-['\201D'] after:font-serif after:absolute after:-bottom-20 after:right-0 after:text-9xl after:text-white after:opacity-25 after:tansform after:-translate-x-2 after:-translate-y-2">
                ...
                <figure class="my-12">
                    <blockquote class="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
                        <p
                            class="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-white before:opacity-25 before:tansform before:translate-x-2 before:-translate-y-2 after:content-['\201D'] after:font-serif after:absolute after:-bottom-20 after:right-0 after:text-9xl after:text-white after:opacity-25 after:tansform after:-translate-x-2 after:-translate-y-2">
                            The Ace Adventurer Rocket has thwarted my Illudium Q-36 Explosive
                            Space Modulator on serveral occassions.
                            <span class="italic">This makes me very,very angry!</span>Nevertheless,K-9 and I have awarded
                            Acme the
                            Martian contract for
                            space exploration rockets based on Acmeos quality and sturdy
                            designs.
                        </p>
                    </blockquote>
                    <figcaption class="italic text-xl sm:text-2xl text-right mt-2 text-slate-500 dark:text-slate-400">
            ...
            <hr class="mx-auto bg-black dark:bg-white w-1/2" />
            <section id="contact"
                class="p-6 my-12 scroll-mt-16 widescreen:section-min-height tailscreen:section-min-height">
                <h2 class="text-4xl font-bold text-center sm:text-5xl mb-6 text-slate-900 dark:text-white">
                    {{ thirdSmallTitle }}
                </h2>
                <form action="" class="max-w-4xl mx-auto text-2xl sm:text-3xl flex flex-col items-left gap-4">
                    ...
                    <buttom
                        class="bg-teal-900 hover:bg-teal-60 active:bg-teal-500 text-white p-3 w-48 rounded-xl border border-solid border-slate-900 dark:border-none cursor-pointer">
                        Submit</buttom>
                </form>
            </section>
        </main>
        <footer class="bg-teal-700 text-white text-xl" id="footer">
            <section class="max-w-4xl mx-auto p-4 flex flex-col sm:flex-row sm:justify-between">
                <address>
                    <h2>Acme Rocket-Powered Products, Inc.</h2>
                    555 Astro Way <br />
                    Fairfield, New Jsersey 12345-5555 <br />
                    Email:
